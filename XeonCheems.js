...
//[gc]\\
        const groupMetadata = m.isGroup ? awai prince BotInc.groupMetadata(m.chat).catch(e => {}) : ''
...
//[target]\\
	const reply = (teks) => {
            PrinceBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/HYj9wu5Jrv6CROxyeQbHoS"}}}, { quoted: m})
        }
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'clone https://github.com/PRINCE-SER/MD-prince'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number👤',
                                    phoneNumber: '+918590565968'
                                }
                            }, {
                                quickReplyButton: {
	    ...
	    case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/918590565968?text=hello+bro+i+found+a+bug+in+your+bot'
                                }
                            }, {
                                quickReplyButton: {
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `prince md`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://github.com/PRINCE-SER/MD-prince'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Script🔖',
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://chat.whatsapp.com/H1eWblY8BhdCML6xfIwonT'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤',
